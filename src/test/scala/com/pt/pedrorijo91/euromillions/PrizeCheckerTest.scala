...
class PrizeCheckerTest extends FunSuite {
  ...
  test("parsing json response should produce expected numbers, stars, date, and prizes") {
    ...
    assert(parsedPrizes.contains((5, 2)) && parsedPrizes.get((5, 2)).isDefined && parsedPrizes.get((5, 2)).get ==(1, 40468528.00f))
    assert(parsedPrizes.contains((5, 1)) && parsedPrizes.get((5, 1)).isDefined && parsedPrizes.get((5, 1)).get ==(8, 182139.77f))
    assert(parsedPrizes.contains((5, 0)) && parsedPrizes.get((5, 0)).isDefined && parsedPrizes.get((5, 0)).get ==(14, 34693.29f))
    assert(parsedPrizes.contains((4, 2)) && parsedPrizes.get((4, 2)).isDefined && parsedPrizes.get((4, 2)).get ==(48, 5059.44f))
    assert(parsedPrizes.contains((4, 1)) && parsedPrizes.get((4, 1)).isDefined && parsedPrizes.get((4, 1)).get ==(986, 215.51f))
    assert(parsedPrizes.contains((4, 0)) && parsedPrizes.get((4, 0)).isDefined && parsedPrizes.get((4, 0)).get ==(2125, 100.00f))
    assert(parsedPrizes.contains((3, 2)) && parsedPrizes.get((3, 2)).isDefined && parsedPrizes.get((3, 2)).get ==(2362, 64.26f))
    assert(parsedPrizes.contains((3, 1)) && parsedPrizes.get((3, 1)).isDefined && parsedPrizes.get((3, 1)).get ==(42752, 15.62f))
    assert(parsedPrizes.contains((3, 0)) && parsedPrizes.get((3, 0)).isDefined && parsedPrizes.get((3, 0)).get ==(88891, 12.64f))
    assert(parsedPrizes.contains((2, 2)) && parsedPrizes.get((2, 2)).isDefined && parsedPrizes.get((2, 2)).get ==(31970, 21.84f))
    assert(parsedPrizes.contains((2, 1)) && parsedPrizes.get((2, 1)).isDefined && parsedPrizes.get((2, 1)).get ==(616908, 8.66f))
    assert(parsedPrizes.contains((2, 0)) && parsedPrizes.get((2, 0)).isDefined && parsedPrizes.get((2, 0)).get ==(1304557, 4.19f))
    assert(parsedPrizes.contains((1, 2)) && parsedPrizes.get((1, 2)).isDefined && parsedPrizes.get((1, 2)).get ==(164891, 11.97f))
  }
